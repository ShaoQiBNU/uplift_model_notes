...
| Y=1, T=0  | Qini curve  | $x \in [1640+9476+9113, 1640+9476+9113+1118]$ | $y = 1640 - 1118 * \frac{1640+9113}{9476+1118} = 505.2205 $ | $k = \frac{505.2205 - 1640}{1118} = -1.01500 $ |

特别地，当 $T=1$ 和 $T=0$ 的样本量相同时，最后一段回归baseline终点的直线斜率为-1。
...
$$ \max \sum_{i=1}^{M} \sum_{j=0}^{N} (v_{i,j} - v_{i,0}) x_{i,j} = \max \left \lbrace \sum_{i=1}^{M} \sum_{j=0}^{N} (v_{i,j} x_{i,j}  - v_{i,0} x_{i,j}) \right \rbrace = \max \left \lbrace \sum_{i=1}^{M} \sum_{j=0}^{N} v_{i,j} x_{i,j}  - \sum_{i=1}^{M} \sum_{j=0}^{N}  v_{i,0} x_{i,j} \right \rbrace =  \max \left \lbrace \sum_{i=1}^{M} \sum_{j=0}^{N} v_{i,j} x_{i,j}  - \sum_{i=1}^{M} v_{i,0} \sum_{j=0}^{N} x_{i,j} \right \rbrace = \max \left \lbrace \sum_{i=1}^{M} \sum_{j=0}^{N} v_{i,j} x_{i,j}  - \sum_{i=1}^{M} v_{i,0} \right \rbrace \iff \max \left \lbrace \sum_{i=1}^{M} \sum_{j=0}^{N} v_{i,j} x_{i,j} \right \rbrace $$
